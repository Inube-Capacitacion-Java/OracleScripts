-- Script que crea tablas y sus bitácoras
-- Crear tablas
...
ALTER TABLE CLIENTES ADD ACTIVO NUMBER(1) DEFAULT 1 NOT NULL;
ALTER TABLE CLIENTES_BIT ADD ACTIVO NUMBER(1) DEFAULT 1 NOT NULL;
...
CREATE INDEX IDX_AUTH_USERNAME ON AUTHORITIES (USERNAME);

INSERT INTO USERS (USERNAME, PASSWORD, ENABLED)
VALUES ('oscar', '$2a$10$wlZ.1RGVnyF1G7Kph5.tguUpMf0Pr6GnnSXHlNjl8JFElhbcxXevC', 1);
...
VALUES ('USER');
DELETE FROM AUTHORITIES WHERE USERNAME = 'oscar';


select * from CLIENTES_BIT;
select * from CLIENTES_BIT order by ID_CLIENTE_BIT;
...
SELECT * FROM USERS;
SELECT * FROM AUTHORITIES WHERE USERNAME = 'oscar';

SELECT * FROM USERS WHERE username = 'oscar';


SELECT * FROM USERS;
SELECT * FROM AUTHORITIES;

select u1_0.id,u1_0.username,u1_0.enabled,u1_0.password from users u1_0 where u1_0.username='oscar'
...
SELECT USERNAME, PASSWORD, ENABLED FROM USERS WHERE USERNAME='OSCAR';
SELECT USERNAME, PASSWORD, ENABLED FROM USERS WHERE UPPER(USERNAME)='OSCAR';


SELECT '"' || USERNAME || '"' AS username_debug, PASSWORD, ENABLED FROM USERS;
...
-- Nuevo usuario: JUAN
INSERT INTO USERS (USERNAME, PASSWORD, ENABLED)
VALUES ('JUAN', '$2a$10$wJ3n8LJ8qT8zEoYkI1e6fuXH0xShb.4T3I3xqv9H7hVqJ5.2cK7aG', 1);

-- Asignarle rol ROLE_USER
INSERT INTO AUTHORITIES (USERNAME, AUTHORITY)
VALUES ('JUAN', 'ROLE_USER');


INSERT INTO USERS (USERNAME, PASSWORD, ENABLED)
VALUES ('PEDRO', '$2a$10$EjemploHashBCryptPara1234', 1);

INSERT INTO AUTHORITIES (USERNAME, AUTHORITY)
VALUES ('PEDRO', 'ROLE_USER');


-- Borrar primero las autoridades del usuario
DELETE FROM AUTHORITIES WHERE USERNAME='OSCAR';

-- Luego borrar el usuario
DELETE FROM USERS WHERE USERNAME='OSCAR';


DELETE FROM AUTHORITIES WHERE USERNAME='JUAN';
...
-- BORRAR REGISTROS VIEJOS SI EXISTEN
DELETE FROM AUTHORITIES WHERE USERNAME IN ('OSCAR','JUAN');
DELETE FROM USERS WHERE USERNAME IN ('OSCAR','JUAN');
...
INSERT INTO USERS (USERNAME, PASSWORD, ENABLED)
VALUES ('JUAN', '$2a$10$wlZ.1RGVnyF1G7Kph5.tguUpMf0Pr6GnnSXHlNjl8JFElhbcxXevC', 1);
...
select * from USERS u1_0 where upper(u1_0.username) = upper('oscar');

SELECT u1_0.id, u1_0.username, u1_0.enabled, u1_0.password
FROM users u1_0
WHERE UPPER(u1_0.username) = UPPER('oscar')

select u1_0.id,u1_0.username,u1_0.password,u1_0.enabled from users u1_0 where upper(u1_0.username)=upper('oscar')